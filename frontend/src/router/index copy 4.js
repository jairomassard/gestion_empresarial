...
import MainMenu from '../views/MainMenu.vue'; // Nueva página principal
import AnalysisMenu from '../views/AnalysisMenu.vue'; // Renombramos HomeView.vue
...
const routes = [
  ...
  },
  {
    path: '/analysis',
    name: 'analysis',
    component: AnalysisMenu, // Este es el HomeView.vue renombrado
    meta: { requiresAuth: true }
  },
  {
    path: '/inventory',
    name: 'inventory',
    component: () => import('../views/InventoryMenu.vue'), // Lo crearemos después
    meta: { requiresAuth: true }
  },
  {
  ...
  },
  {
    ...
    meta: { requiresAuth: true, seccion: 'inventario', subseccion: 'bodegas', permiso: 'ver' } // Permiso 'ver' para acceso básico
  },
  {
  ...
  },
  {
    ...
    component: () => import('../views/CargarNotasCredito.vue'), // Cambiado a carga dinámica
  ...
  },
  {
    path: '/production',
    name: 'production',
    component: () => import('../views/ProductionMenu.vue'), // Lo crearemos después
    meta: { requiresAuth: true }
  },
  {
  ...
  // Rutas de análisis (mantenemos las existentes bajo /analysis si quieres reorganizar)
  { path: '/upload', name: 'UploadMenu', component: UploadMenu, meta: { requiresAuth: true, seccion: 'cargue', permiso: 'editar' } },
  { path: '/upload/sales', name: 'UploadSales', component: UploadSales, meta: { requiresAuth: true, seccion: 'cargue', permiso: 'editar' } },
  { path: '/upload/arqueo', name: 'UploadArqueo', component: UploadArqueo, meta: { requiresAuth: true, seccion: 'cargue', permiso: 'editar' } },
  { path: '/upload/venta-mensual', name: 'UploadVentaMensual', component: UploadVentaMensual, meta: { requiresAuth: true, seccion: 'cargue', permiso: 'editar' } },
  { path: '/upload/budget', name: 'UploadBudget', component: UploadBudget, meta: { requiresAuth: true, seccion: 'cargue', permiso: 'editar' } },
  ...
  { path: '/points-of-sale', name: 'PointsOfSale', component: PointsOfSale, meta: { requiresAuth: true, seccion: 'parametrizacion', permiso: 'editar' } },
...
// Mantén el router.beforeEach sin cambios por ahora
