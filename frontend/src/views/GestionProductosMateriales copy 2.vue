...
export default {
  ...
  setup() {
    ...
    const inputCsv = ref(null); // Nueva referencia para el input de archivo
    ...
    const limpiarPagina = () => {
      ...
      offset.value = 0;
      limpiarSesionCsv(); // Llamar a limpiarSesionCsv aquí
    };
    ...
    const limpiarSesionCsv = () => {
      ...
      erroresCsv.value = '';
      if (inputCsv.value) inputCsv.value.value = ''; // Usar la referencia inputCsv
    };
    ...
    const mostrarInstructivo = () => mostrarModal.value = true;
    ...
    return {
      ...
      erroresCsv,
      mostrarModal,
      inputCsv, // Exponer la referencia para el template
      crearProducto,
      consultarProductos,
      cargarMaterialesProducto,
      cargarProductosDisponibles,
