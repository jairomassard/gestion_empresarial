...
export default {
  ...
  setup() {
    ...
    const permisos = ref({
      ...
      parametrizacion_perfiles: [],  // Nueva clave para Creación de Perfiles
      parametrizacion_usuarios: [],  // Nueva clave para Creación de Usuarios
      inventario_gestion_productos: [],  // Nueva subsección
      production_alguna_subseccion: [],  // Nueva subsección (ejemplo)
    });
    ...
    const secciones = [
      ...
      },
      {
        ...
        subsecciones: [
          ...
          { name: 'perfiles', permisos: ['editar'] },  // Nueva subsección para Creación de Perfiles
          { name: 'usuarios', permisos: ['editar'] },  // Nueva subsección para Creación de Usuarios
        ],
      },
      {
        name: 'inventario',
        permisos: ['ver'],  // Permiso general
        subsecciones: [
          { name: 'gestion_productos', permisos: ['editar'] },  // Subsección específica
        ],
      },
      {
        name: 'production',
        permisos: ['ver'],  // Permiso general
        subsecciones: [
          { name: 'alguna_subseccion', permisos: ['ver'] },  // Ejemplo, ajusta según necesidades
        ],
      },
    ];
    ...
    const clearPermisos = () => {
      permisos.value = {
        ...
        parametrizacion_perfiles: [],  // Nueva clave
        parametrizacion_usuarios: [],  // Nueva clave
        inventario_gestion_productos: [],
        production_alguna_subseccion: [],
      };
    };
...
.secciones-grid {
  display: grid;
  grid-template-columns: repeat(3, 1fr); /* 3 columnas para las secciones */
